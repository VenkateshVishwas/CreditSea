...
import { adminUserColumns, AdminUserResponse, UserInterfaceVerifier } from "../utils/usercoloumns";


function AdminUsersDashboard() {
    const [userData, setUserData] = useState<UserInterfaceVerifier[]>([]);
                ...
                <div className="grid grid-rows-[3.5fr_6.5fr]">
                    <div className="grid grid-rows-[1.5fr_8.5fr]">
                        ...
                        <div className="grid grid-rows-2 grid-cols-3 gap-4 p-4">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-[4fr_6fr] xl:grid-cols-[2.5fr_7.5fr] rounded-lg sm:rounded-none shadow-md">
                                ...
                                <div className="bg-white sm:w-full rounded-lg sm:rounded-none">
                                    <p className="w-full h-2/5 pl-1 sm:pl-4 pt-2 font-bold text-sm xl:text-2xl">0</p>
                    ...
                    <div className="flex justify-center items-center">
                        <div className="h-5/6 w-full md:w-5/6">
                            <Table columns={adminUserColumns} dataSource={userData} title={() => "Users"} pagination={{ position: ["bottomCenter"] }} />
                        </div>
                    </div>
                </div>
            </div>
